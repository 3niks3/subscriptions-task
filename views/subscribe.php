    ...
    <div class="sidebar">
        ...
        <div class="row content">
            <div class="row middle-pos-flex item-gap content-items">
                ...
                <div class="row " style="border-top:solid thin  #E3E3E4"></div>

                <div class="row just-content-center">
                    <div class="col w-auto">
                        <a href="#" class="social-icons facebook">
                            <svg class="facebook" width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
